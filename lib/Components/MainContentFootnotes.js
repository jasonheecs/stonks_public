    ...
    <footer>
      <ul>
        ...
        <li>
          ...
          {showMath ? (
            <ul>
              ...
              <li>
                weighted cost = (approx price around post timestamp * post
                points) for each post / shares
              </li>
              <li>
                gain/loss = ((price - weighted cost) / weighted cost) * 100
              </li>
            </ul>
          ) : null}
        </li>
        ...
        <li>
          ...
          . The whole thing is pretty much in javascript, so unless you know how
          to speak my language, stay on the bench, and{" "}
        ...
        <li>
          ...
          and helpless... if you have any respect for someone's work,
          don't-fucking-do-it.
        </li>
      </ul>
    </footer>
